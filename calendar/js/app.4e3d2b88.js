(function (t) {
    function e(e) {
        for (var a, i, s = e[0], c = e[1], l = e[2], u = 0, h = []; u < s.length; u++)
            (i = s[u]),
                Object.prototype.hasOwnProperty.call(n, i) && n[i] && h.push(n[i][0]),
                (n[i] = 0);
                ...
                return e('div', { attrs: { id: 'app' } }, [
                    e(
                        ...
                        [
                            e('div', { staticClass: 'now-data-myself' }, [
                                ...
                                e(
                                    'div',
                                    {
                                        ...
                                        attrs: { title: t.currentNotebook.name },
                                    },
                                    [t._v(' ' + t._s(t.week) + ' ')]
                                ),
                                t.showNotebookList
                                    ? e(
                                          'div',
                                          {
                                              ...
                                              on: { click: t.handleNotebookClick },
                                          },
                            ...
                            e('Calendar', {
                                ref: 'Calendar',
                                attrs: { markDate: t.markArr, textTop: t.textTop },
                                on: { choseDay: t.clickDay, changeMonth: t.changeDate },
                            }),
                        ],
                        1
                    ),
                ...
                methods: {
                            ...
                            if (0 === i.code && i.data) {
                                ...
                                try {
                                    window.open('siyuan://blocks/' + t),
                                        (this.DateLinkToNote[o] = 'siyuan://blocks/' + t),
                                        this.markArr.push(o);
                                    let e = '',
                                        a = await this.request('/api/system/getConf');
                                    if (
                                        (a && a.data.conf.system.workspaceDir
                                            ? (e = a.data.conf.system.workspaceDir.replace(
                                                  /\\/g,
                                                  '/'
                                              ))
                                            : console.error('获取工作空间目录失败，请手动设置'),
                                        0 === n.code && n.data && n.data.conf)
                                    ) {
                                        let o = n.data.conf,
                                            a = '';
                                        if (o.dailyNoteTemplatePath) {
                                            let n =
                                                    `${e}/data/templates${o.dailyNoteTemplatePath}`.replace(
                                                        /\//g,
                                                        '\\'
                                                    ),
                                                r = { id: t, path: n },
                    ...
                    async handleWeekClick() {
                        ...
                        0 === t.code &&
                            t.data &&
                            t.data.notebooks &&
                            (this.notebookList = t.data.notebooks.filter(t => !1 === t.closed));
                    },
                },
            },
            l = c,
