...
## v2.7.0/ 20250929
- ♻️ refactor：重构列表转换样式，自定义属性名改为list2

## v2.6.9/ 2025-09-28
- 💄 style(折叠样式): 隐藏折叠标题的悬停效果
- 🎨 列表转标签页优化
  - 转标签页减少空白等待时间
  - 优化标签页转回列表，现在会恢复为原先列表样式了，不需要手动刷新
  - 手机端不显示tab-restore-button，电脑端才显示

## v2.6.8 / 20250916
- ✨支持列表转标签页
  - 支持记忆当前标签页，刷新和重新打开文档，依然是打开上次的标签页
  - 由于修改了 DOM 结构，恢复列表后，需要按 f5 刷新，才能正常恢复

## v2.6.7 / 20250912
- 💄改进列表转看板样式

## v2.6.6 / 20250904
- ✨列表转时间线功能，参考https://ld246.com/article/1756998809429
...
- ✨ feat(theme): 添加国际化支持
- ✨ 完善主题块菜单插入逻辑 [#129](https://github.com/Achuan-2/siyuan-themes-tsundoku/issues/129)


## v2.6.2 / 2025.07.20

- 💄 style(editor.css): 调整下划线样式为波浪形


## v2.6.1 / 2025.07.12
- 💄 style(list2table.css): 列表转导图优化标题样式
- 💄 style(tab-bar): 垂直页签样式优化
...
## v2.5.8 /2025.07.04
- ✨ 支持垂直页签
- 💄 style(editor.css): 调整标题颜色样式
- 💄 style(database): 优化数据库卡片视图样式
- ✨ 代码块滚动时复制按钮固定在编辑器顶部



## v2.5.7 /2025.07.03
- 💄style(layout): 调整页签栏缩放比例
- 🐛fix：「列表转脑图、表格」的功能有时候无法显示
- 💄style(database): 调整数据库画廊视图预览笔记内容的字体大小
