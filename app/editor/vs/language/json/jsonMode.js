    ...
    var moduleExports = (() => {
        ...
        (function (e) {
            ...
            function i(r) {
                var n = r;
                return (
                    s.defined(n) && s.string(n.uri) && (n.version === null || s.integer(n.version))
                );
            }
            e.is = i;
        })(ce || (ce = {}));
        ...
        (function (e) {
            ...
            function i(r) {
                var n = r;
                return (
                    s.string(n) || (s.objectLiteral(n) && s.string(n.language) && s.string(n.value))
                );
            }
            e.is = i;
        })(fe || (fe = {}));
        ...
        (function (e) {
            ...
            function i(r) {
                var n = r;
                return (
                    s.defined(n) && y.is(n.range) && (s.undefined(n.target) || s.string(n.target))
                );
            }
            e.is = i;
        })(an || (an = {}));
            ...
            function a() {
                ...
                vn(i),
                    ...
                    c.documentRangeFormattingEdits &&
                        i.push(
                            l.languages.registerDocumentRangeFormattingEditProvider(u, new Q(n))
                        ),
                    c.completionItems &&
                        i.push(
                            l.languages.registerCompletionItemProvider(u, new X(n, [' ', ':', '"']))
                        ),
