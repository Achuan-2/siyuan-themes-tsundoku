 ...
 *-----------------------------------------------------------*/ (function () {
        ...
        class R {
            static validateConfigurationOptions(s) {
                ...
                if (
                    ...
                    s.baseUrl.length > 0 &&
                        (x.Utilities.endsWith(s.baseUrl, '/') || (s.baseUrl += '/')),
            ...
            _applyPaths(s) {
                ...
                for (let L = 0, h = this.sortedPathsRules.length; L < h; L++)
                    if (((p = this.sortedPathsRules[L]), x.Utilities.startsWith(s, p.from))) {
                        let a = [];
                        for (let w = 0, e = p.to.length; w < e; w++)
                            a.push(p.to[w] + s.substr(p.from.length));
                        return a;
                    }
                return [s];
            }
            ...
            shouldInvokeFactory(s) {
                return !!(
                    ...
                    (this.options.buildForceInvokeFactory &&
                        this.options.buildForceInvokeFactory[s])
                );
            }
    ...
    (function (x) {
        ...
        function D(h) {
            ...
            try {
                return (
                    (a ? self.eval(a.createScript('', 'true')) : new Function('true')).call(self),
                    !0
                );
            } catch {
                return !1;
        ...
        class i {
            ...
            _canUseEval(a) {
                return (
                    this._cachedCanUseEval === null && (this._cachedCanUseEval = D(a)),
                    ...
                    if (
                        ...
                        fetch(w)
                            ...
                            .then(g => {
                                (g = `${g}
//# sourceURL=${w}`),
                                    (f ? self.eval(f.createScript('', g)) : new Function(g)).call(
                                        self
                                    ),
                                    e();
                            })
        ...
        class s {
            ...
            _initNodeRequire(a, w) {
                ...
                f.prototype._compile = function (g, S) {
                    ...
                    return (
                        b._handleCachedData(r, E, _, !d.cachedData, w),
                        b._verifyCachedData(r, E, _, C, w),
                        m
                    );
                };
            }
            load(a, w, e, b) {
                ...
                if (/^node\|/.test(w)) {
                    ...
                    this._readSourceAndCachedData(E, d, S, (C, r, u, o) => {
                        ...
                        this._handleCachedData(m, c, d, _ && !u, a),
                            this._verifyCachedData(m, c, d, o, a);
                    });
                }
            }
            ...
            _createAndWriteCachedData(a, w, e, b) {
                let f = Math.ceil(
                        b.getConfig().getOptionsLiteral().nodeCachedData.writeDelay *
                            (1 + Math.random())
                    ),
                    v = -1,
                    g = 0,
                        ...
                        if (!(y.length === 0 || y.length === v || g >= 5)) {
                            ...
                            (v = y.length),
                                this._fs.writeFile(e, Buffer.concat([S, y]), _ => {
                                    _ && b.getConfig().onError(_),
                                        b.getRecorder().record(63, e),
                                        E();
                                });
                        }
                    }, f * Math.pow(4, g++));
        ...
        class p {
            ...
            _normalizeDependencies(h, a) {
                ...
                for (let b = 0, f = h.length; b < f; b++)
                    w[e++] = this._normalizeDependency(h[b], a);
                return w;
            }
...
`)
                        ...
                        if (
                            ((this._inverseDependencies2[b.id] =
                                this._inverseDependencies2[b.id] || []),
            ...
            _onModuleComplete(h) {
                ...
                const b = g =>
                    (this._inverseDependencies2[g] || []).map(S =>
                ...
                if (v) {
                    ...
                    for (let g = 0, S = v.length; g < S; g++)
                        this._loadPluginDependency(h.exports, v[g]);
                }
            }
        }
        x.ModuleManager = p;
    ...
    Q(Y[25], X([0, 1]), function (x, n) {
        ...
        function f(v, g, S, E) {
            ...
            if (!v || v.length === 0)
                return S({
                    ...
                    getConfiguredDefaultLocale: () => {
                        var o;
                        return (o = _.availableLanguages) === null || o === void 0
                            ? void 0
                            : o['*'];
                    },
                });
            ...
            const u = o => {
                Array.isArray(o) ? (o.localize = h(o)) : (o.localize = h(o[v])),
                    (o.getConfiguredDefaultLocale = () => {
                        var c;
                        return (c = _.availableLanguages) === null || c === void 0
                            ? void 0
                            : c['*'];
                    }),
                    S(o);
        ...
        (function () {
            ...
            const R = globalThis.MonacoEnvironment,
                ...
                i =
                    typeof ((x = self.trustedTypes) === null || x === void 0
                        ? void 0
                        : x.createPolicy) == 'function'
            ...
            function s() {
                try {
                    return (
                        (i
                            ? globalThis.eval(i.createScript('', 'true'))
                            : new Function('true')
                        ).call(globalThis),
                        !0
                    );
...
//# sourceURL=${f}`),
                                    (i
                                        ? globalThis.eval(i.createScript('', g))
                                        : new Function(g)
                                    ).call(globalThis),
                                    e();
                            })
                    ...
                    L(),
                        require([e], function (b) {
                            setTimeout(function () {
                                ...
                                for (
                                    globalThis.onmessage = v => f.onmessage(v.data, v.ports);
                                    w.length > 0;
        ...
        Q(Y[26], X([0, 1]), function (x, n) {
            ...
            class H {
                ...
                findLastMaxBy(U) {
                    ...
                    return (
                        this.iterate(
                            t => ((W || N.isGreaterThan(U(t, T))) && ((W = !1), (T = t)), !0)
                        ),
                        T
                    );
                }
        ...
        Q(Y[27], X([0, 1]), function (x, n) {
            ...
            class R {
                ...
                get(s) {
                    ...
                    return (
                        this.lastArgKey !== p &&
                            ((this.lastArgKey = p), (this.lastCache = this.fn(s))),
                        this.lastCache
                    );
                }
            }
...
` +
        ...
        Q(Y[15], X([0, 1]), function (x, n) {
            ...
            (function (D) {
                ...
                function* y(d, C, r = d.length) {
                    for (
                        C < 0 && (C += d.length),
                            r < 0 ? (r += d.length) : r > d.length && (r = d.length);
                        C < r;
                        C++
                    )
                        yield d[C];
        ...
        Q(Y[29], X([0, 1]), function (x, n) {
            ...
            (function () {
                ...
                for (const g of b) {
                    ...
                    r && (n.EVENT_KEY_CODE_MAP[r] = d),
                        u && (n.NATIVE_WINDOWS_KEY_CODE_TO_KEY_CODE[u] = d);
                }
        ...
        Q(Y[11], X([0, 1, 14, 15]), function (x, n, R, D) {
            ...
            class r {
                ...
                deleteAndDispose(o) {
                    var c;
                    (c = this._store.get(o)) === null || c === void 0 || c.dispose(),
                        this._store.delete(o);
                }
                [Symbol.iterator]() {
        ...
        Q(Y[5], X([0, 1, 27, 30]), function (x, n, R, D) {
            ...
            function c(P, O, V = 0, j = P.length, Z = 0, le = O.length) {
                for (; V < j && Z < le; V++, Z++) {
                    ...
                    if (ve === oe) continue;
                    if (ve >= 128 || oe >= 128)
                        return u(P.toLowerCase(), O.toLowerCase(), V, j, Z, le);
            ...
            class v {
                ...
                update(S) {
                    ...
                    let _ = this._buffLen,
                        ...
                        r;
                    for (
                        d !== 0 ? ((C = d), (r = -1), (d = 0)) : ((C = S.charCodeAt(0)), (r = 0));
                        ;
            ...
            class a {
                ...
                WALKTRACE(e, b, f, v, g, S, E, y, _, d, C, r, u, o, c, l, m, N) {
                    ...
                    if (((A = k.getReverseChanges()), N[0])) {
                        ...
                        if (A !== null && A.length > 0) {
                            ...
                            (U = Math.max(U, W.getOriginalEnd())),
                                (T = Math.max(T, W.getModifiedEnd()));
                        }
                    ...
                    for (let B = 1; B <= o / 2 + 1; B++) {
                        ...
                        for (let T = d; T <= C; T += 2) {
                            T === d || (T < C && l[T - 1] < l[T + 1])
                                ...
                                (_ = y - (T - N) - M);
                            const W = y;
                            for (; y < b && _ < v && this.ElementsAreEqual(y + 1, _ + 1); )
                                y++, _++;
                            if (
                                ((l[T] = y),
                                y + _ > H + F && ((H = y), (F = _)),
                ...
                PrettifyChanges(e) {
                    ...
                    for (let b = e.length - 1; b >= 0; b--) {
                        ...
                        if (b > 0) {
                            const C = e[b - 1];
                            (v = C.originalStart + C.originalLength),
                ...
                _OriginalRegionIsBoundary(e, b) {
                    ...
                    if (b > 0) {
                        const f = e + b;
                        if (this._OriginalIsBoundary(f - 1) || this._OriginalIsBoundary(f))
                            return !0;
                    }
                    return !1;
                }
                ...
                _ModifiedRegionIsBoundary(e, b) {
                    ...
                    if (b > 0) {
                        const f = e + b;
                        if (this._ModifiedIsBoundary(f - 1) || this._ModifiedIsBoundary(f))
                            return !0;
                    }
                    return !1;
                }
        ...
        Q(Y[18], X([0, 1]), function (x, n) {
            ...
            function g(E, y) {
                if (R(y)) {
                    if (typeof E !== y)
                        throw new Error(`argument does not match constraint: typeof ${y}`);
                } else if (f(y)) {
                    try {
        ...
        Q(Y[20], X([0, 1, 19]), function (x, n, R) {
            ...
            class D {
                ...
                get(p) {
                    return p >= 0 && p < 256
                        ? this._asciiMap[p]
                        : this._map.get(p) || this._defaultValue;
                }
                clear() {
        ...
        Q(Y[6], X([0, 1, 4]), function (x, n, R) {
            ...
            class D {
                ...
                join(s) {
                    return new D(
                        Math.min(this.start, s.start),
                        Math.max(this.endExclusive, s.endExclusive)
                    );
                }
                intersect(s) {
        ...
        Q(Y[2], X([0, 1, 3]), function (x, n, R) {
            ...
            class D {
                ...
                static plusRange(s, p) {
                    ...
                    return (
                        p.startLineNumber < s.startLineNumber
                            ...
                            : p.startLineNumber === s.startLineNumber
                            ? ((L = p.startLineNumber),
                              (h = Math.min(p.startColumn, s.startColumn)))
                ...
                static lift(s) {
                    return s
                        ? new D(s.startLineNumber, s.startColumn, s.endLineNumber, s.endColumn)
                        : null;
                }
                static isIRange(s) {
                    return (
            ...
            class i extends D.Range {
                ...
                static selectionsArrEqual(p, L) {
                    ...
                    for (let h = 0, a = p.length; h < a; h++)
                        if (!this.selectionsEqual(p[h], L[h])) return !1;
                    return !0;
                }
        ...
        Q(Y[7], X([0, 1, 4, 6]), function (x, n, R, D) {
            ...
            class i {
                static trivial(a, w) {
                    return new i(
                        [new s(new D.OffsetRange(0, a.length), new D.OffsetRange(0, w.length))],
                        !1
                    );
                }
        ...
        Q(Y[35], X([0, 1, 6, 7]), function (x, n, R, D) {
            ...
            function p(a, w, e) {
                ...
                for (let f = 1; f < e.length; f++) {
                    ...
                    if (g.seq1Range.isEmpty) {
                        ...
                        for (let y = 1; y <= E; y++)
                            if (
                                w.getElement(g.seq2Range.start - y) !==
                                w.getElement(g.seq2Range.endExclusive - y)
                            ) {
                                S = !1;
                                break;
                            }
            ...
            function h(a, w, e, b, f) {
                ...
                for (
                    ...
                    e.getElement(a.seq2Range.start - g) ===
                        e.getElement(a.seq2Range.endExclusive - g) &&
                    g < 20;
                ...
                for (
                    ...
                    e.getElement(a.seq2Range.start + S) ===
                        e.getElement(a.seq2Range.endExclusive + S) &&
                    S < 20;
            ...
            class i {
                compute(a, w, e = D.InfiniteTimeout.instance) {
                    if (a.length === 0 || w.length === 0)
                        return D.DiffAlgorithmResult.trivial(a, w);
                    function b(C, r) {
                        for (
                            ;
                            C < a.length && r < w.length && a.getElement(C) === w.getElement(r);
                    ...
                    for (;;) {
                        ...
                        if (
                            ((C !== _ || r !== d) &&
                                y.push(
                                    new D.SequenceDiff(
                                        new R.OffsetRange(C, _),
                                        new R.OffsetRange(r, d)
                                    )
                                ),
                            !E)
                        )
            ...
            class s {
                compute(L, h, a = D.InfiniteTimeout.instance, w) {
                    if (L.length === 0 || h.length === 0)
                        return D.DiffAlgorithmResult.trivial(L, h);
                    ...
                    function E(d, C) {
                        (d + 1 !== g || C + 1 !== S) &&
                            v.push(
                                new D.SequenceDiff(
                                    new R.OffsetRange(d + 1, g),
                                    new R.OffsetRange(C + 1, S)
                                )
                            ),
                            (g = d),
                            (S = C);
        ...
        Q(Y[39], X([0, 1, 17, 23, 5, 2, 10, 21]), function (x, n, R, D, i, s, p, L) {
            ...
            class e {
                constructor(C) {
                    const r = [],
                        u = [];
                    for (let o = 0, c = C.length; o < c; o++)
                        (r[o] = E(C[o], 1)), (u[o] = y(C[o], 1));
            ...
            function v(d) {
                ...
                for (let u = 1, o = d.length; u < o; u++) {
                    ...
                    Math.min(l, m) < h
                        ? ((r.originalLength =
                              c.originalStart + c.originalLength - r.originalStart),
                    ...
                    if (
                        ...
                        if (I.getElements().length > 0 && B.getElements().length > 0) {
                            ...
                            for (let F = 0, U = H.length; F < U; F++)
                                q.push(f.createFromDiffChange(H[F], I, B));
                        }
                    }
            ...
            function (x, n, R, D, i, s, p, L, h, a, w, e) {
                ...
                class b {
                    ...
                    computeDiff(m, N, A) {
                        ...
                        for (const re of W) {
                            (0, R.assertFn)(
                                () => re.seq1Range.start - ue === re.seq2Range.start - de
                            );
                            const se = re.seq1Range.start - ue;
                            ie(se),
                                (ue = re.seq1Range.endExclusive),
                                (de = re.seq2Range.endExclusive);
                        ...
                        return (
                            ...
                            (H = (0, a.smoothenSequenceDiffs)(q, I, H)),
                            {
                                mappings: H.map(
                                    U =>
                                        new e.RangeMapping(
                                            q.translateRange(U.seq1Range),
                                            I.translateRange(U.seq2Range)
                                        )
                                ),
                        ...
                        let B = function (W, t) {
                            ...
                            if (!M || !M.s1Range.containsRange(W) || !M.s2Range.containsRange(t))
                                if (
                                    M &&
                                    !(
                                        M.s1Range.endExclusive < W.start &&
                                        M.s2Range.endExclusive < t.start
                                    )
                                ) {
                                    const se = i.OffsetRange.tryCreate(
                                            M.s1Range.endExclusive,
                                            W.start
                                        ),
                                        ge = i.OffsetRange.tryCreate(
                                            M.s2Range.endExclusive,
                                            t.start
                                        );
                                    (M.deleted +=
                                        (te = se?.length) !== null && te !== void 0 ? te : 0),
                                        (M.added +=
                                            (ie = ge?.length) !== null && ie !== void 0 ? ie : 0),
                ...
                function v(l, m) {
                    ...
                    for (; l.length > 0 || m.length > 0; ) {
                        const A = l[0],
                            M = m[0];
                        let k;
                        A && (!M || A.seq1Range.start < M.seq1Range.start)
                            ? (k = l.shift())
                            : (k = m.shift()),
                            N.length > 0 &&
                            N[N.length - 1].seq1Range.endExclusive >= k.seq1Range.start
                ...
                function S(l, m, N) {
                    ...
                    l.modifiedRange.startColumn - 1 >=
                        N[l.modifiedRange.startLineNumber - 1].length &&
                        l.originalRange.startColumn - 1 >=
                            m[l.originalRange.startLineNumber - 1].length &&
                        (A = 1),
...
`.charCodeAt(0)
                    ...
                    getBoundaryScore(m) {
                        ...
                        let M = 0;
                        return (
                            N !== A && ((M += 10), A === 1 && (M += 1)), (M += u(N)), (M += u(A)), M
                        );
                    }
                    translateOffset(m) {
                        if (this.lineRange.isEmpty)
                            return new s.Position(this.lineRange.start + 1, 1);
                        let N = 0,
                    ...
                    return u
                        ? u.regex.multiline
                            ? this._doFindMatchesMultiline(
                                  y,
                                  d,
                                  new S(u.wordSeparators, u.regex),
                                  C,
                                  r
                              )
...
`
                    ...
                    for (d.reset(0); (N = d.next(o)); )
                        if (
                            ((l[m++] = w(
                                this._getMultilineMatchRange(y, u, o, c, N.index, N[0]),
                                N,
                                C
                            )),
                            m >= r)
                ...
                static _doFindNextMatchMultiline(y, _, d, C) {
                    const r = new i.Position(_.lineNumber, 1),
                        ...
                        o = y.getLineCount(),
                        c = y.getValueInRange(
                            new s.Range(r.lineNumber, r.column, o, y.getLineMaxColumn(o)),
                            1
                        ),
                        l =
                            y.getEOL() ===
...
`
                ...
                static _findFirstMatchInLine(y, _, d, C, r) {
                    ...
                    const u = y.next(_);
                    return u
                        ? w(new s.Range(d, u.index + 1, d, u.index + 1 + u[0].length), u, r)
                        : null;
                }
                ...
                static _doFindPreviousMatchMultiline(y, _, d, C) {
                    ...
                    return _.lineNumber !== u || _.column !== y.getLineMaxColumn(u)
                        ? this._doFindPreviousMatchMultiline(
                              y,
                              new i.Position(u, y.getLineMaxColumn(u)),
                              d,
                              C
                          )
                        : null;
        ...
        Q(Y[48], X([0, 1, 2, 47, 5, 10, 22]), function (x, n, R, D, i, s, p) {
            ...
            function h(e, b) {
                return `[${i.escapeRegExpCharacters(
                    e.map(v => String.fromCodePoint(v)).join('')
                )}]`;
            }
            class a {
                constructor(b) {
                ...
                getCandidateCodePoints() {
                    ...
                    if (this.options.invisibleCharacters)
                        for (const f of i.InvisibleCharacters.codePoints)
                            w(String.fromCodePoint(f)) || b.add(f);
                    if (this.options.ambiguousCharacters)
                        for (const f of this.ambiguousCharacters.getConfusableCodePoints())
                            b.add(f);
...
` ||
        ...
        Q(Y[49], X([0, 1]), function (x, n) {
            ...
            (function (t) {
                (t[(t.acceptSuggestionOnCommitCharacter = 0)] =
                    ...
                    (t[(t.renderLineHighlightOnlyWhenFocus = 92)] =
        ...
        Q(Y[8], X([0, 1, 50]), function (x, n, R) {
            ...
            const d =
                    typeof ((D = _?.versions) === null || D === void 0 ? void 0 : D.electron) ==
                    'string',
                C = d && _?.type === 'renderer';
            ...
            n.win32 = {
                    ...
                    for (let l = r.length - 1; l >= -1; l--) {
                        ...
                        if (l >= 0) {
                            ...
                            u.length === 0
                                ...
                                : ((m = R.env[`=${u}`] || R.cwd()),
                                  (m === void 0 ||
                                      (m.slice(0, 2).toLowerCase() !== u.toLowerCase() &&
                                          m.charCodeAt(2) === a)) &&
                                      (m = `${u}\\`));
                        const N = m.length;
                        let A = 0,
                ...
                relative(r, u) {
                    ...
                    const o = n.win32.resolve(r),
                        c = n.win32.resolve(u);
                    if (o === c || ((r = o.toLowerCase()), (u = c.toLowerCase()), r === u))
                        return '';
                    let l = 0;
                    ...
                    if (B !== q) {
                        ...
                        N > q && (r.charCodeAt(l + B) === a ? (I = B) : B === 2 && (I = 3)),
                            I === -1 && (I = 0);
                    }
                    let H = '';
                    for (B = l + I + 1; B <= m; ++B)
                    ...
                    return (
                        ...
                        H.length > 0
                            ? `${H}${c.slice(A, M)}`
                            : (c.charCodeAt(A) === a && ++A, c.slice(A, M))
                    );
                },
                toNamespacedPath(r) {
                ...
                dirname(r) {
                    ...
                    if (S(l)) {
                        ...
                        y(l) &&
                            r.charCodeAt(1) === w &&
                            ((o = u > 2 && S(r.charCodeAt(2)) ? 3 : 2), (c = o));
                    let m = -1,
                        N = !0;
                    for (let A = u - 1; A >= c; --A)
                        if (S(r.charCodeAt(A))) {
                ...
                parse(r) {
                    ...
                    let c = 0,
                        l = r.charCodeAt(0);
                    if (o === 1)
                        return S(l) ? ((u.root = u.dir = r), u) : ((u.base = u.name = r), u);
                    if (S(l)) {
            ...
            (n.posix = {
                resolve(...r) {
                    ...
                    for (let c = r.length - 1; c >= -1 && !o; c--) {
                        const l = c >= 0 ? r[c] : C();
                        v(l, 'path'),
                            l.length !== 0 && ((u = `${l}/${u}`), (o = l.charCodeAt(0) === h));
                    }
...
`)
                                ...
                                queueMicrotask(() => {
                                    ...
                                    for (const q of M)
                                        q.subscription.isset() &&
                                            (q.subscription.unset(),
                                            (k = q.stack) === null || k === void 0 || k.print());
                                });
                            }
                        ...
                        this._event ||
                            (this._event = (l, m, N) => {
                                ...
                                this._leakageMon &&
                                    ...
                                    ((B = f.create()),
                                    (I = this._leakageMon.check(B, this._listeners.size + 1))),
                                    L && (B = B ?? f.create());
                                const H = new v(l, m, B),
            ...
            class _ extends g {
                ...
                fire(l) {
                    this._listeners &&
                        (this._isPaused !== 0 ? this._eventQueue.push(l) : super.fire(l));
                }
            }
                ...
                if ((N && ((m += N), (m += ':')), (A || N === 'file') && ((m += e), (m += e)), A)) {
                    ...
                    if (I !== -1) {
                        ...
                        (A = A.substr(I + 1)),
                            ...
                            I === -1
                                ? (m += l(B, !1, !1))
                                : ((m += l(B.substr(0, I), !1, !1)),
                                  (m += ':'),
                                  (m += l(B.substr(I + 1), !1, !0))),
                            (m += '@');
                    }
                    (A = A.toLowerCase()),
                        (I = A.lastIndexOf(':')),
                        I === -1
                            ? (m += l(A, !1, !0))
                            : ((m += l(A.substr(0, I), !1, !0)), (m += A.substr(I)));
                }
                if (M) {
                    if (M.length >= 3 && M.charCodeAt(0) === 47 && M.charCodeAt(2) === 58) {
                        ...
                        I >= 65 &&
                            I <= 90 &&
                            (M = `/${String.fromCharCode(I + 32)}:${M.substr(3)}`);
                    ...
                    const m = new D.Emitter({
                        ...
                        onDidRemoveLastListener: () => {
                            this._pendingEmitters.delete(l),
                                this._send(new g(this._workerId, l)),
                                (l = null);
                        },
                    });
                    return m.event;
                            ...
                            m.detail instanceof Error &&
                                ...
                                this._send(
                                    new b(
                                        ...
                                        c,
                                        void 0,
                                        (0, R.transformErrorForSerialization)(m)
                                    )
                                );
                        }
                    );
                ...
                constructor(o, c, l) {
                    ...
                    typeof A < 'u' && typeof A.getConfig == 'function'
                        ...
                        : typeof globalThis.requirejs < 'u' &&
                          (N = globalThis.requirejs.s.contexts._.config);
                ...
                _handleMessage(o, c) {
                    ...
                    try {
                        return Promise.resolve(
                            this._requestHandler[o].apply(this._requestHandler, c)
                        );
                    } catch (l) {
                        ...
                        : (c &&
                          ...
                          new Promise((k, q) => {
                              (globalThis.require || x)(
                                  ...
                                  B => {
                                      if (
                                          ((this._requestHandler = B.create(M)),
        ...
        Q(Y[55], X([0, 1, 32, 13, 2, 54]), function (x, n, R, D, i, s) {
            ...
            function f(_) {
                return (
                    ...
                    (i.Range.isIRange(_.originSelectionRange) ||
                        i.Range.isIRange(_.targetSelectionRange))
                );
            }
            n.isLocationLink = f;
            var v;
            ...
            (n.LazyTokenizationSupport = y),
                (n.TokenizationRegistry = new s.TokenizationRegistry());
        }),
        Q(
            Y[56],
            ...
            function (x, n, R, D, i, s, p, L, h, a, w, e, b, f, v) {
                ...
                class g extends p.MirrorTextModel {
                    ...
                    getWordAtPosition(_, d) {
                        ...
                        return C
                            ? new s.Range(_.lineNumber, C.startColumn, _.lineNumber, C.endColumn)
                            : null;
                    }
                    words(_) {
                        const d = this._lines,
                ...
                class S {
                    ...
                    computeMoreMinimalEdits(_, d, C) {
                        return be(this, void 0, void 0, function* () {
                            ...
                            for (let { range: c, text: l, eol: m } of d) {
                                if ((typeof m == 'number' && (o = m), s.Range.isEmpty(c) && !l))
                                    continue;
                            ...
                            e: for (const l of _) {
                                ...
                                if (m) {
                                    for (const N of m.words(o))
                                        if (
                                            !(N === d || !isNaN(Number(N))) &&
                                            (c.add(N), c.size > S._suggestionsLimit)
                                        )
                                            break e;
                                }
                            }
                    ...
                    navigateValueSet(_, d, C, r, u) {
                        return be(this, void 0, void 0, function* () {
                            ...
                            const l = o.getValueInRange(d),
                                m = o.getWordAtPosition(
                                    { lineNumber: d.startLineNumber, column: d.startColumn },
                                    c
                                );
                            if (!m) return null;
                    ...
                    loadForeignModule(_, d, C) {
                        const r = (c, l) => this._host.fhr(c, l),
                            o = {
                                host: (0, v.createProxyObject)(C, r),
                    ...
                    fmr(_, d) {
                        if (!this._foreignModule || typeof this._foreignModule[_] != 'function')
                            return Promise.reject(
                                new Error('Missing requestHandler or method: ' + _)
                            );
                        try {
                            return Promise.resolve(
                                this._foreignModule[_].apply(this._foreignModule, d)
                            );
                        } catch (C) {
